...
\begin{center}\begin{tabular}{|c|c|c|c|c|c|} \hline
	structure & algebra & commutative algebra & left $A$-module & right $B$-module & $(A,B)$-bimodule \\ \hline
	category & $\cate{Alg}(\mathcal{V})$ & $\cate{CAlg}(\mathcal{V})$ & $A\dcate{Mod}$ & $\cated{Mod}B$ & $(A,B)\dcate{Mod}$ \\ \hline
	condition & {\small $\mathcal{V}$: monoidal category} & {\small $\mathcal{V}$: braided monoidal category} & {\small $A$: algebra} & {\small $B$: algebra} & {\small $A, B$: algebras} \\ \hline
