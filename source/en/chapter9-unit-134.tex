...
\begin{Exercises}
	...
	% The Indonesian witness carried literal `qquad`; the frozen Chinese source
	% at chapter9.tex:2011 authoritatively has \quad.
	\[ |X|\simeq\int^{[n]\in\simpDelta}X_n\times|\Delta^n|,\quad
	X\in\Obj(\cate{sSet}). \]
