...
% 目的: 设置章节标题格式及目录的显示方式.
% 由 AJbook.cls 引入
\ProvidesFile{titles-setup-en.tex}[2026/09/01 English title formatting]
...
% Chapter/appendix labels for the English edition.  Avoid xstring here:
% titlesec can pass a protected expansion of \thechapter, which makes
% \IfSubStr fail while parsing a perfectly ordinary chapter title.
\providecommand{\AJappendixletterA}{}
\providecommand{\AJappendixletterB}{}
\providecommand{\AJchapterttl}[1]{%
	\ifcsname AJappendixletter#1\endcsname Appendix #1\else Chapter #1\fi}
...
% Part numbering for the English edition
