...
\begin{remark}\label{rem:profinite-group-lim}
	...
	\begin{align*}
		...
		& \simeq \varprojlim_j \Hom_{\cate{TopGrp}}\left( \varprojlim_i G_i, H_j \right) \quad \text{(by the universal property of inverse limits)} \\
		& \simeq \varprojlim_j \varinjlim_i \Hom_{\cate{Grp}}(G_i,H_j) \quad \text{(every continuous homomorphism factors through some \(G_i\))};
	\end{align*}
	}
