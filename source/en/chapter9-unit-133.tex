...
\begin{center}\begin{tabular}{|c|c|c|c|c|} \hline
	Multiplication & Comultiplication $\Delta$ & Unit & Counit $\epsilon$ & Antipode $S$ \\ \hline
	Pointwise multiplication & $f \mapsto \left[ (g_1, g_2) \mapsto f(g_1 g_2) \right]$ & Constant function $1$ & $f \mapsto f(1_G)$ & $(Sf)(g) = f(g^{-1})$ \\ \hline
